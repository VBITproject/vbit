...
This means one can have an always-on vbitd instance running, and another local vbitd/vbit-qt instance which connects to this node and receives blocks from it.
