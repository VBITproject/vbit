...
RESOURCES += src/qt/vbit.qrc src/qt/vbit_locale.qrc

TRANSLATIONS += src/qt/locale/vbit_bg.ts \
                src/qt/locale/vbit_de.ts \
                src/qt/locale/vbit_en.ts \
                src/qt/locale/vbit_es.ts \
                src/qt/locale/vbit_fi.ts \
                src/qt/locale/vbit_fr.ts \
                src/qt/locale/vbit_it.ts \
                src/qt/locale/vbit_ja.ts \
                src/qt/locale/vbit_pl.ts \
                src/qt/locale/vbit_pt.ts \
                src/qt/locale/vbit_ru.ts \
                src/qt/locale/vbit_sk.ts \
                src/qt/locale/vbit_sv.ts \
                src/qt/locale/vbit_vi.ts \
                src/qt/locale/vbit_zh_CN.ts \
                src/qt/locale/vbit_zh_TW.ts
