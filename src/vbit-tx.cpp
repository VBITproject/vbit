...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("VBIT Core vbit-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  vbit-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded vbit transaction") + "\n" +
                               "  vbit-tx [options] -create [commands]   " + _("Create hex-encoded vbit transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded vbit transaction
