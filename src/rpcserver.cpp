...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* VBIT features */
        {"vbit", "masternode", &masternode, true, true, false},
        {"vbit", "masternodelist", &masternodelist, true, true, false},
        {"vbit", "mnbudget", &mnbudget, true, true, false},
        {"vbit", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"vbit", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"vbit", "mnsync", &mnsync, true, true, false},
        {"vbit", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"vbit", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use vbitd, or the -server option to vbit-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> vbit-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:63095/\n";
}
