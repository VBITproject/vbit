                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("VBIT Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a VBIT address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and vbit: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About VBIT Core"), this);
    aboutAction->setStatusTip(tr("Show information about VBIT Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for VBIT"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your VBIT addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified VBIT addresses"));
    ...
    openAction->setStatusTip(tr("Open a VBIT: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the VBIT Core help message to get a list with possible VBIT command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("VBIT Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to VBIT network", "", count));
}
...
{
    QString strTitle = tr("VBIT Core"); // default title
