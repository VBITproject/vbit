...
#if defined(NDEBUG)
#error "VBIT cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 0) {
        nSubsidy = 70000 * COIN;
    } else if (nHeight <= 7500 && nHeight > 0) {
        nSubsidy = 0.5 * COIN;
    } else if (nHeight <= 46000 && nHeight > 7500) {
        nSubsidy = 2.5 * COIN;
	} else if (nHeight <= 375000 && nHeight > 46000) {
        nSubsidy = 5 * COIN;
	} else if (nHeight <= 784000 && nHeight > 375000) {
        nSubsidy = 2.5 * COIN;
	} else if (nHeight <=  146700 && nHeight > 784000) {
        nSubsidy = 1 * COIN;
	} else if (nHeight <= 18426024 && nHeight > 146700) {
		nSubsidy = 0.5 * COIN;
	} else if (nHeight > 18426024) {
		nSubsidy = 0 * COIN;
    } else {
        nSubsidy = 0 * COIN;
    }
