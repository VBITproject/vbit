...
In order to support loading of multiple wallets in vbit-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is vbit.cpp.
...
Changes to vbit.cpp
----------------------
vbit.cpp is the entry point into vbit-qt, and as such, will require some minor modifications to provide hooks for
