VBIT Core version 2.2.1 is now available from:

  <https://github.com/vbit-project/vbit/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/vbit-project/vbit/issues>

Compatibility
==============

VBIT Core is extensively tested on multiple operating systems using
...
VBIT Core should also work on most other Unix-like systems but is not
...
of Bitcoin that VBIT was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/vbit-project-translations/).
