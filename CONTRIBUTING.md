Contributing to VBIT Core
============================

The VBIT Core project operates an open contributor model where anyone is
...
The following applies to code changes to the VBIT Core project, and is not to be
confused with overall VBIT Network Protocol consensus changes.

Whether a pull request is merged into VBIT Core rests with the project merge
...
Patches that change VBIT consensus rules are considerably more involved than
...
Where a patch set proposes to change the VBIT consensus, it must have been
...
The project leader is the release manager for each VBIT Core release.
